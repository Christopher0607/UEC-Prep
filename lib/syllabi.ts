...
export const PAPER_STRUCTURES: PaperStructure[] = [
  ...
  },
  {
    ...
    papers: [
      {
        name: "试卷一（60 分钟）",
        parts: [{ name: "选择题", marks: "约 40%", detail: "20 题，全答" }],
      },
      {
        name: "试卷二（120 分钟）",
        parts: [{ name: "作答题", marks: "约 60%", detail: "题目未到手，拿到后补" }],
      },
    ],
    takeaways: [
      "2026 预考试卷一 16/20。非微积分 15/15 全对，微积分只有 1/4 —— 四道错题里三道在微积分。",
      "微积分板块和高级数学重叠。高数试卷二崩溃的也是这一块 —— 补一次，数学（10/23）和高数（10/27）两科同时受益。",
      "卷面自标「Tembak」（猜）的有 5 题：Q3 指数根式、Q8 对数、Q9 三角象限、Q17 微分、Q19 积分。蒙对 2 题。真实掌握度是 15/20，不是 16/20 —— 蒙对的两个考点要当成不会来补。",
      "Q18 丢分是算完了没走最后一步：求出的是切线斜率 4，法线要取负倒数 −1/4。这类「最后一步」该进考前自查表，不是知识点。",
    ],
  },
  {
    subjectId: "business",

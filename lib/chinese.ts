...
/**
 * 现代文阅读的答题公式 —— 试卷二最大的一块（24%），也是 2026 预考丢得最多的一块。
 *
 * 这些题看起来千变万化，实际上只有八种。每一种都有固定的采分骨架：
 * 写够骨架就拿满分，少一段就少一分。和应用文的逐格给分是同一个道理 ——
 * 阅读题不是「读懂了就会答」，是「知道这一类要写哪几段」。
 */
...
export const READING_FORMULAS: AnswerFormula[] = [
  {
    type: "中心论点 / 主旨",
    cue: "「作者在文中表达了什么中心论点？」「本文的主旨是什么？」",
    formula: [
      "先定位：议论文看标题、首段末句、末段首句；散文看反复出现的那个词",
      "句式：作者认为，＋〔对象〕＋ 是／应该 ＋〔观点〕",
      "必须是一个**完整的判断句**，不能只抄一个词组",
    ],
    trap: "抄了一整段原文当答案。论点是一句话，不是一段话。",
  },
  {
    type: "论证方法 ＋ 作用",
    cue: "「第 X 段运用了哪一种论证方法？有何作用？」",
    formula: [
      "点明方法：举例论证／道理论证（引用论证）／对比论证／比喻论证／类比论证",
      "指出材料：举了〔谁〕的例子／引用了〔谁〕的话／把〔A〕和〔B〕作对比",
      "接上观点：有力地论证了〔本段观点〕",
      "收效果：使论证更〔具体有说服力／深刻／鲜明／通俗易懂〕",
    ],
    trap: "只写「举例论证」四个字。3 分的题要四段，写一段拿一分。",
  },
  {
    type: "原因题",
    cue: "「造成这种 X 的主要原因是什么？」「为什么……？」",
    formula: [
      "答案**一定在画线句的前后文**，先回原文圈出来",
      "句式：因为 ＋〔原文的原因句，压缩成自己的话〕",
      "原文若列了两三条，就分点写两三条",
    ],
    trap: "凭印象作答。这一类题不需要发挥，需要定位。",
  },
  {
    type: "理解句子的深刻含义",
    cue: "「如何理解『……』这句话？」「试写出『……』的深刻含义」",
    formula: [
      "表层：这句话字面上说的是什么",
      "深层：把关键词换成自己的话（「一本大书」→ 值得反复阅读、内涵丰富）",
      "挂钩：它体现／支持了全文〔中心论点〕",
    ],
    trap: "只把原句换个说法重讲一遍，没有第三层。",
  },
  {
    type: "联系实际谈看法",
    cue: "「你认为……？请说明理由，并谈谈……」「结合自己的生活体验谈谈看法」",
    formula: [
      "亮明态度：我认为〔是／不是／认同哪一种〕—— 1 分",
      "结合原文讲理由：因为作者说〔……〕—— 1 分",
      "联系自身／生活的具体做法：例如我〔……〕—— 1 分",
    ],
    trap: "只写态度和空泛道理，没有第三段。3 分的题必须落到具体的人或事。",
  },
  {
    type: "段落作用（能不能删）",
    cue: "「有人说第 1 段可以删掉，你认同吗？」",
    formula: [
      "先表态：不认同，不能删",
      "内容上：这一段写了〔……〕",
      "结构上：引出下文／为下文作铺垫／与结尾照应／总领全文／设置悬念",
      "反证：删掉之后〔文章就少了……，显得突兀〕",
    ],
    trap: "只答「不能删，因为很重要」。要说清楚重要在内容还是结构。",
  },
  {
    type: "修辞手法 ＋ 表达效果",
    cue: "「画线句运用了什么修辞手法？试分析其表达效果」",
    formula: [
      "点明手法：比喻／拟人／排比／夸张／反问／对偶／反复",
      "说清本体喻体：把〔A〕比作〔B〕／赋予〔A〕人的〔动作情态〕",
      "写出效果：生动形象地写出了〔对象〕〔什么特点〕",
      "落到情感：表达了作者〔什么感受／心境〕",
    ],
    trap: "2026 预考只写了「比喻」两个字 —— 3 分的题这样最多拿 1 分。",
  },
  {
    type: "选择题（哪一项不正确）",
    cue: "「下列何者不正确？」",
    formula: [
      "每个选项都回原文**定位到具体段落**，逐句比对",
      "错的选项通常是这四种：原文说反了／原文根本没说／范围被扩大或缩小／因果被调换",
      "找到矛盾的那一句，在原文上划线",
    ],
    trap: "凭语感选「读起来怪的那个」。四个选项都通顺，差别只在跟原文对不对得上。",
  },
];

/** 课内文言文：范围固定，是整份卷子最该拿满的一块。每篇按这四样准备。 */
export const WENYAN_PREP = [
  { item: "全文口语翻译", note: "逐句译一遍，不求文采，求每个字都落实。译不出来的字就是要背的实词。" },
  { item: "重点实词 5–8 个", note: "做成卡：正面写「余嘉其能行古道」的「嘉」，背面写「赞许」。" },
  { item: "中心思想一句话", note: "《师说》＝ 论证从师学习的必要，批判耻于从师的风气，提出「能者为师」。" },
  { item: "名句默写", note: "「师者，所以传道受业解惑也」「闻道有先后，术业有专攻」这类必出的句子。" },
];

/** 翻译题的采分点 —— 每句 2 分，就是这四项里踩中两项。 */
export const TRANSLATION_POINTS = [
  "关键实词译准（嘉＝赞许、贻＝赠送、行古道＝遵行古人从师之道）",
  "特殊句式还原（判断句「……者，……也」、被动句、宾语前置）",
  "补出省略的成分（主语、宾语、介词）",
  "整句通顺，是现代汉语的话",
];

/** 语病六型 —— 修改病句题每年必考，认出类型就改得出来。 */
export const SENTENCE_ERRORS = [
  { type: "成分残缺", sign: "读完觉得「少了点什么」", fix: "补主语／宾语／结构助词「的」" },
  { type: "搭配不当", sign: "主谓、动宾、修饰语配不拢", fix: "换掉其中一方" },
  { type: "语序不当", sign: "多项定语或状语排错", fix: "按「领属→数量→性质」排" },
  { type: "重复啰嗦", sign: "「大约……左右」「非常十分」", fix: "删掉一个" },
  { type: "关联词误用", sign: "「虽然……那么」这种配不上的", fix: "改成「既然……那么」「虽然……但是」" },
  { type: "句式杂糅", sign: "两种说法硬接在一起", fix: "只留一种" },
];
